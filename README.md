...
**Lumina is a portfolio/passion project built for educational purposes.** It is a Direct-to-Consumer (DTC) tool, not a healthcare provider, and is not HIPAA compliant. The analysis provided by this application is generated by Artificial Intelligence and should not be used as a substitute for professional medical advice, diagnosis, or treatment. Always consult with a qualified healthcare provider.
